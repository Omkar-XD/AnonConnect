...
import startup from "/public/startup.webp";
...
function ChatRooms() {
  ...
  const rooms = [
    ...
    },
    {
      ...
      image: startup,
      description:
        "Share ideas, discuss strategies, and connect with entrepreneurs. Perfect for side hustles or scaling big.",
    },
  ];
      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/80 border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {/* Logo Image */}
            <img
              src="/AnonConnect-logo.png" // place your logo inside public/logo.png
              alt="AnonConnect Logo"
              className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl object-cover shadow-md border border-gray-200"
            />
            <span className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900 select-none">
              AnonConnect
            </span>
          </div>
